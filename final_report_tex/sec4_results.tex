...
\bottomrule
\end{tabularx}
\caption{Per-bin tracking reward $R_j$ at end of training, sprint-retune reward of \S3.1.4, 3000 PPO iterations per cell. Each entry is the mean $\pm$ standard deviation over the last 200 PPO iterations of the curve obtained by averaging the three seeds.}
